...
class Helper
{
  ...
  public function validarSaldo($string)
  {
    $valido = false;
    if ($string >= 0) {
      $valido = true;
  ...
  public function enviarCorreo($correo, $usuario)
  {
    ...
    try {
      ...
      $html = "<p>Tu código de verificación es: <b style='font-size: 30px;'>$cod_verificacion</b></p><br><a href='http://localhost/DSS2023/Proyecto/cuentas-cliente/views/login/verificar.php?usuario=$usuario'>Verificar</a>";
      $mail->Body = $html;
      $mail->send();
      $enviado = true;
    } catch (Exception $e) {
  ...
  public function enviarCorreo2($correo, $usuario, $pass)
  {
    $enviado = false;
    try {
      $mail = new PHPMailer(true);
      ...
      $html = "<p style='font-size: 17px;'>¡Bienvenido! <br><br> <b>Usuario: </b>$usuario <br><br> <b>Contraseña: </b>$pass</p>";
      $mail->Body = $html;
      $mail->send();
      $enviado = true;
    } catch (Exception $e) {
