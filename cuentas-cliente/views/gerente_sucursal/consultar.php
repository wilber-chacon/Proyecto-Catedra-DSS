    ...
    <form action="../../controllers/procesarAccion.php" method="post" class="formA p-5" style="margin: auto;">
      ...
      <div class="row">
        ...
        <div class="col-md-4 form-group">
          ...
          <input type="text" class="form-control" name="dui" id="dui" value="<?php print($empleado->getdui()); ?>"
        ...
        <div class="col-md-4 form-group">
          ...
          <input type="tel" class="form-control" placeholder="0000-0000"
            value="<?php print($empleado->gettelefono()); ?>" name="telefono" id="telefono" readonly
            pattern="^[0-9]{4}-[0-9]{4}$" />
        </div>
        ...
        <div class="col-md-4 form-group">
          ...
          <input type="date" name="fechanacimiento" id="fechanacimiento"
            value="<?php print($empleado->getfechanacimiento()); ?>" class="form-control datepicker" readonly>
        </div>
        <div class="col-md-8 form-group">
        ...
        <div class="col-md-4 form-group">
          ...
          <input type="text" class="form-control" value="<?php print($empleado->getnombrerol()); ?>" name="rol" id="rol"
            readonly />
        </div>
        <div class="col-md-4 form-group">
          <label for="sucursal" class="col-sm-12 col-form-label">Sucursal:</label>
          <input type="text" class="form-control" value="<?php print($empleado->getsucursal()); ?>" name="sucursal"
            id="sucursal" readonly />
        </div>
        <div class="col-md-4 form-group">
          <label for="estado" class="col-sm-12 col-form-label">Estado:</label>
          <input type="text" class="form-control" name="estado" value="<?php print($empleado->getestado()); ?>"
            id="estado" readonly>
        </div>
        <div class="col-md-4 form-group">
          <label for="pass" class="col-sm-12 col-form-label">Contraseña:</label>
          <input type="text" class="form-control" name="pass" value="<?php print($empleado->getpass()); ?>" id="pass"
            readonly>
        </div>
        <div class="col-md-12">
