...
<body>
    ...
    <div class="container mt-4 mb-4 p-5">
        <form action="../../controllers/CajeroController.php" method="post" class="formA p-5"
            style="background-color: #EEEEEE; margin: auto;">
            <h3 class="text-center m-3 mb-5">Retiro de dinero</h3>
            <?php
            if ($_GET) {
            ...
            <div class="row m-auto">
                ...
                <div class="col-md-9 m-auto form-group">
                    <label for="montor" class="col-sm-12 col-form-label">Monto a retirar:</label>
                    <input type="number" class="form-control" name="montor" id="montor" min="0.1" step="0.01"
                        placeholder="0.00" required>
                </div>

                <div class="col-md-12">
                    <input type="hidden" name="operacion" id="operacion" value="retiro">
