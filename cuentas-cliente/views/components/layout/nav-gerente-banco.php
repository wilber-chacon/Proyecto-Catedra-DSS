<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="./administrar_empleados.php">Administrar acciones</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="./administrar_sucursales.php">Administrar sucursales</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="./verMovimientos.php">Movimientos</a>
      </li>
    </ul>
