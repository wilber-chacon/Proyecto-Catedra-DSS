<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="./transferencias.php">Transferencias</a>
      </li>
    </ul>
      ...
      <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
          <p class="dropdown-item" style="cursor: default;">
            ...
            <?php 
              echo $_SESSION['usuario'][0]["nombre_cliente"];
             ?>
          </p>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="../../controllers/procesarLogin.php?operacion=salirP">Aceptar</a>
      </div>
    </div>
  </div>
</div>