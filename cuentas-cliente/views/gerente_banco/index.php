            ...
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="h5 mb-0 font-weight-bold text-gray-800 text-uppercase">
                  <a href="administrar_empleados.php" class="text-info"
                    style="display: block; margin: 25px 10px">Administrar acciones de personal
                  </a>
                </div>
              </div>
              <div class="col-auto">
        ...
        <div class="card border-left-warning shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="h5 mb-0 font-weight-bold text-gray-800 text-uppercase">
                  <a href="./administrar_sucursales.php" class="text-warning"
                    style="display: block; margin: 25px 10px">Administrar
                    sucursales</a>
                </div>
              </div>
              <div class="col-auto">
        ...
        <div class="card border-left-success shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="h5 mb-0 font-weight-bold text-gray-800 text-uppercase">
                  <a href="./verMovimientos.php" class="text-success"
                    style="display: block; margin: 25px 10px">Ver movimientos 
                    </a>
                </div>
              </div>
              <div class="col-auto">
              ...
              <div class="col mr-2">
                <div class="h5 mb-0 font-weight-bold text-gray-800 text-uppercase">
                  <a href="#" class="text-danger" data-toggle="modal" data-target="#logoutModal"
                    style="display: block; margin: 25px 10px">Salir</a>
                </div>
              </div>
              <div class="col-auto">
