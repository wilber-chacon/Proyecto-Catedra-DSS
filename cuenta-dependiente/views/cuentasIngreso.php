...
<body>
  ...
  <form action="../controllers/procesarAccion.php" method="post" class="formA p-5" style="background-color: #EEEEEE; margin: auto;">
  <h3 class="text-center m-3 mb-5">Consultar cuentas</h3>
      ...
      <div class="row m-auto">
        ...
        <div class="col-md-12">
          <input type="hidden" name="operacion" id="operacion" value="vercuentasIngreso">
