<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="./cuentasIngreso.php">Ingreso de efectivo</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="./cuentasRetiro.php">Retiro de efectivo</a>
      </li>
    </ul>
      ...
      <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
          <p class="dropdown-item" style="cursor: default;">
            ...
            <?php if (isset($_SESSION['usuarioD'])) {
              echo $_SESSION['usuarioD'];
            } ?>
          </p>
